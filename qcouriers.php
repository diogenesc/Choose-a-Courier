...
<body>
  ...
  <main class="container">
    ...
    <?php
    echo "<table"." class="."striped"." ><thead><tr><td>Empresa de correios</td><td>Tempo de chegada ao Brasil</td><td>Média de entrega</td></thead><tbody>";
    while($linha=mysqli_fetch_row($resultByDays)){
      echo "<tr><td>".$linha[8];
